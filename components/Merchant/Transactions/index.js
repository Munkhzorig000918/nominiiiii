        ...
        <div className='w-5/6 bg-white rounded-20 py-5 space-y-5'>
            <div className='flex items-center justify-between px-5'>
                <div className='flex items-center space-x-4'>
                    <input className='w-80 bg-transparent text-sm placeholder:text-main-disabled text-main-primary border-[0.5px] border-main-disabled rounded-5 py-2 pl-8 pr-4 focus:outline-none' type='text' placeholder='Record ID / Tx ID / CIF / Reference' />
                    <Button text={"Search"} />
